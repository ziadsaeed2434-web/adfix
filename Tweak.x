...
NSArray *generate10IPs() {
    ...
    NSArray *greekSubnets = @[
        ...
        @{@"first": @212, @"second": @205}  // Nova / Wind
    ];
...
// ============================================================
// MARK: - دوال العمليات المضمونة في الخلفية
// ============================================================
...
- (void)viewDidLoad {
    ...
    NSString *locationInfo = [NSString stringWithFormat:@"📍 الموقع الحالي (أثينا، اليونان):\nLat: %.4f\nLon: %.4f", currentLat, currentLon];
    NSString *ipInfo = [NSString stringWithFormat:@"🌐 IP الجلسة اليوناني الوهمي:\n%@\n\n🛡️ IP الشبكة الفعلي:\n%@", sessionFakeIP ?: @"غير محدد", currentRealIP];
