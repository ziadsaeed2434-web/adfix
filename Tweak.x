...
// ============================================================
// MARK: - المتغيرات العامة (من الكودين)
// ============================================================

// --- متغيرات الموقع والشبكة ---
...
// --- متغيرات بصمة الجهاز (من التويك السابق) ---
...
// ============================================================
// MARK: - دوال توليد عشوائي (من الكودين)
// ============================================================
...
// ============================================================
// MARK: - دوال الموقع و IP (من الكود الأصلي)
// ============================================================
...
void clearNetworkCache() {
    ...
    // إنشاء NSURLCache جديد بسعة صفر
    NSURLCache *newCache = [[NSURLCache alloc] initWithMemoryCapacity:0 diskCapacity:0 diskPath:nil];
...
// ============================================================
// MARK: - العمليات الرئيسية (الزر الأزرق والبرتقالي)
// ============================================================

void performFullReset() {
    // --- توليد بصمة جهاز جديدة ---
...
// ============================================================
// MARK: - واجهة عرض التقارير (من الكود الأصلي)
// ============================================================
...
// ============================================================
// MARK: - الأزرار العائمة وإدارتها (من الكود الأصلي)
// ============================================================
...
// ============================================================
// MARK: - Hooks (من الكودين معاً)
// ============================================================

// --- Hook لـ ASIdentifierManager ---
...
// --- Hook لـ NSURLSession (IP spoofing + User-Agent spoofing) ---
%hook NSURLSession
- (NSURLSessionDataTask *)dataTaskWithRequest:(NSURLRequest *)request completionHandler:(void (^)(NSData *data, NSURLResponse *response, NSError *error))completionHandler {
    ...
    [mutableReq setValue:nil forHTTPHeaderField:@"Cookie"]; // إزالة الكوكيز
...
// --- Hook لـ NSURLConnection (IP spoofing + User-Agent spoofing) ---
...
// --- Hook لـ UIDevice (الخصائص العامة) ---
%hook UIDevice
- (NSString *)name {
...
// ============================================================
// MARK: - Private Methods Swizzling (آمن)
// ============================================================
...
%ctor {
    ...
    // تهيئة الـ hooks العامة
    %init;
    
    // Swizzling للـ private methods بأمان
